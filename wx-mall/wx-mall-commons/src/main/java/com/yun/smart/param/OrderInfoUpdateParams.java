 ...
 */
public class OrderInfoUpdateParams extends TokenParams {
	
	private static final long serialVersionUID = -2602064056346158592L;
	...
	/** 收货地址ID */
	private Long addrId;
	/** 订单状态：1=购物车 2=待付款 3=待发货 4=待收货 5=已取消 6=已完成 7=售后中 */
